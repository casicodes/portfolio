        ...
        <div className="text-center flex flex-col items-center gap-3 max-w-64">
          <div className="icon-wrapper relative flex">
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="custom-icon left-icon bg-white shadow-sm rounded-lg border-gray-200 border"
            >
              <path
                strokeLinecap="round"
            ...
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="custom-icon center-icon bg-white shadow-sm rounded-lg border-gray-200 border"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="custom-icon right-icon bg-white shadow-sm rounded-lg border-gray-200 border"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <h2 className="font-semibold">Let's build something awesome!</h2>
          <p className="text-gray-500 font-light">
            Jump in and see what you can create with us.
          </p>
          <a
            href="javascript:void(0)"
            className="bg-white rounded-lg px-3 py-2 leading-6 shadow-sm hover:bg-gray-100 glowing-btn"
          >
            Let's Get Started
          </a>
        </div>
